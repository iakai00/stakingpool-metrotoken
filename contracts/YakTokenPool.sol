...
contract YakTokenPool {
    string public name = "YAK Token Pool";
    address public owner;
    YakToken public yakToken;
    ...
    constructor(YakToken _yakToken, MetroToken _metroToken ) public { 
        yakToken = _yakToken;
    ...
    function issueTokens() public {
        ...
        for (uint i=0; i<stakers.length; i++) {
            ...
            if(balance > 0) {
                yakToken.transfer(recipient, balance);
            }
        }
    }
}

...
import "./BabaToken.sol";
import "./MetroToken.sol";

contract BabaTokenPool {
    string public name = "BABA Token Pool";
    address public owner;
    BabaToken public babaToken;
    ...
    constructor(BabaToken _babaToken, MetroToken _metroToken ) public { 
        babaToken = _babaToken;
    ...
    function issueTokens() public {
        ...
        for (uint i=0; i<stakers.length; i++) {
            ...
            if(balance > 0) {
                babaToken.transfer(recipient, balance);
            }
        }
    }
}

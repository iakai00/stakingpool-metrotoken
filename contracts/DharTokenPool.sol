...
import "./DharToken.sol";
import "./MetroToken.sol";

contract DharTokenPool {
    string public name = "DHAR Token Pool";
    address public owner;
    DharToken public dharToken;
    ...
    constructor(DharToken _dharToken, MetroToken _metroToken ) public { 
        dharToken = _dharToken;
    ...
    function issueTokens() public {
        ...
        for (uint i=0; i<stakers.length; i++) {
            ...
            if(balance > 0) {
                dharToken.transfer(recipient, balance);
            }
        }
    }
}
